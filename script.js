// CSV Dataset
const csv_jumlah_penduduk = "dataset/jumlah_penduduk.csv";
const csv_jumlah_wisatawan = "dataset/jumlah_wisatawan.csv";
const csv_jumlah_kejahatan = "dataset/jumlah_kejahatan.csv";
const csv_jumlah_usaha_mikro = "dataset/jumlah_usaha_mikro.csv";
const csv_jumlah_izin_bangunan = "dataset/jumlah_izin_bangunan.csv";
